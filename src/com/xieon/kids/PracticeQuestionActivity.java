...
public class PracticeQuestionActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.kids_practice);
		...
		Button check=(Button)findViewById(R.id.kids_check);
		Button explain=(Button)findViewById(R.id.kids_explaination);
		Button next=(Button)findViewById(R.id.kids_next);
		Button back=(Button)findViewById(R.id.kids_bck);
		...
		check.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				RadioButton option1=(RadioButton) findViewById(R.id.kids_radioButton1);
				RadioButton option2=(RadioButton) findViewById(R.id.kids_radioButton2);
				RadioButton option3=(RadioButton) findViewById(R.id.kids_radioButton3);
				RadioButton option4=(RadioButton) findViewById(R.id.kids_radioButton4);
				...
				RadioGroup radioGroup=(RadioGroup) findViewById(R.id.kids_radioButtons);
	...
	private void setPracticeQuestion(List<PracticeQuestion> data, int current) {
		...
		TextView num = (TextView) findViewById(R.id.kids_questionNoLevel);
		num.setText("Q. "+(current+1)+" ");
		TextView question = (TextView) findViewById(R.id.kids_questionLevel);
