...
import com.xieon.utility.ImageGetterUtility;
...
public class ExplainPracticeActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.kids_explain);
		...
		Button back = (Button) findViewById(R.id.kids_explain_back);
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(getBaseContext(),
						PracticeQuestionActivity.class);
	...
	private void setPracticeExplain(List<PracticeQuestion> data, int current) {
		...
		TextView num = (TextView) findViewById(R.id.kids_explain_questionNoLevel);
		num.setText("Q. " + (current + 1) + " ");
		TextView question = (TextView) findViewById(R.id.kids_explain_questionLevel);
		question.setText(Html.fromHtml(practiceQuestion.getQuestion()));

		TextView explain = (TextView) findViewById(R.id.kids_explain_text);
		explain.setText(Html.fromHtml(practiceQuestion.getExplanation(),
				ImageGetterUtility.getImageGetterUtility(this), null));
